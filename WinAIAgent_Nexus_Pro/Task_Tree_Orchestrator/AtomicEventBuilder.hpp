#ifndef WIN_AI_AGENT_NEXUS_PRO_TASK_TREE_ORCHESTRATOR_ATOMICEVENTBUILDER_HPP
#define WIN_AI_AGENT_NEXUS_PRO_TASK_TREE_ORCHESTRATOR_ATOMICEVENTBUILDER_HPP
...
class AtomicEventBuilder final {
 public:
