#ifndef WIN_AI_AGENT_NEXUS_PRO_STATE_RECOVERY_CHECKPOINT_REGISTRYROLLBACKPLAN_HPP
#define WIN_AI_AGENT_NEXUS_PRO_STATE_RECOVERY_CHECKPOINT_REGISTRYROLLBACKPLAN_HPP
...
class RegistryRollbackPlan final {
 public:
