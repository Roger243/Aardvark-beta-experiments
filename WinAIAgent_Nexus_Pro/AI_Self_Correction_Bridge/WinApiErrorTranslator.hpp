#ifndef WIN_AI_AGENT_NEXUS_PRO_AI_SELF_CORRECTION_BRIDGE_WINAPIERRORTRANSLATOR_HPP
#define WIN_AI_AGENT_NEXUS_PRO_AI_SELF_CORRECTION_BRIDGE_WINAPIERRORTRANSLATOR_HPP
...
class WinApiErrorTranslator final {
 public:
