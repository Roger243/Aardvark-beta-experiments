...
public sealed class JsonStorageProvider : IPersistentStorage
{
    public Task SaveAsync(ExecutionLogEntry entry, CancellationToken cancellationToken = default)
        => throw new NotImplementedException("JSON provider wiring is intentionally deferred to integration phase.");
